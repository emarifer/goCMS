...
func TestHomePagePing(t *testing.T) {

	// This is gonna be the in-memory mysql
	appSettings := helpers.GetAppSettings(1)
...
func TestHomePostExists(t *testing.T) {

	// This is gonna be the in-memory mysql
	appSettings := helpers.GetAppSettings(2)
	...
	require.Contains(t, w.Body.String(), "Gofiber Templ Htmx")
}
