...
goCMS is a headless CMS (Content Management System) written in Golang, designed to be fast, efficient, and easily extensible. It allows you to
...
```bash
go get -u github.com/username/goCMS
```
...
goCMS relies on the following Golang dependencies:
...
goCMS is released under the MIT License. See LICENSE (TODO) for
details. Feel free to fork, modify, and use it in your projects!',
'This is goCMS! This post is an example of how markdown can be rendered as a post.'
);
-- +goose StatementEnd
